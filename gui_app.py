...
class SentimentGui:
    ...
    def _run_analysis(self):
        ...
        try:
            ...
            # 5. Téma – két szint (CLI-vel megegyező logika)
            self._update_status("Per-dokumentum TF-IDF kulcsszó-kinyerés...")
            ...
            self._update_status("BERTopic klaszterezés (korpusz-szintű témák)...")
            ...
            self.root.after(0, lambda: messagebox.showinfo("Elemzés Befejezve", uzenet))

        except Exception as e:
            import traceback
            traceback.print_exc()
            hiba_szoveg = str(e)
            self.root.after(0, lambda: messagebox.showerror("Hiba", f"Hiba az elemzes soran:\n{hiba_szoveg}"))
        finally:
